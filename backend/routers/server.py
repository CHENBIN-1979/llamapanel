...
SERVER_PARAMS_META = {
    ...
    "ubatch_size": {
        ...
        "description": "🔬 AI「真正一次性处理」的字数。可以理解成上面的batch-size是「计划读多少」，而这个是「一口吃多少」。一口吃太多可能噎着（显存爆掉）。\n💡 建议：保持默认512即可。如果内存/显存充足想提提速，可以试试1024。如果报显存不足，降到256或128。一般设成 batch-size 的 1/4 左右比较稳妥。",
        "default": "512",
        "placeholder": "512",
        "min": 32,
        "max": 999999,
